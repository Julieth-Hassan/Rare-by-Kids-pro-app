    ...
    <div id="top-announcement-bar" className="bg-neutral-950 text-neutral-100 text-xs py-1.5 px-4 border-b border-neutral-800/80">
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2 text-center sm:text-left">
        <div className="flex items-center justify-center sm:justify-start gap-2 flex-wrap">
          <span className="inline-flex items-center gap-1 text-[#FFA085] font-semibold bg-[#F06543]/15 border border-[#F06543]/30 px-2 py-0.5 rounded-full text-[11px]">
          ...
          <a
            ...
            className="inline-flex items-center gap-1 font-semibold text-neutral-200 hover:text-[#FFA085] transition-colors"
          >
        ...
        <div className="flex items-center justify-center gap-2.5 text-neutral-300 text-[11px]">
          <span className="hidden md:flex items-center gap-1 text-neutral-400">
            <Truck className="w-3 h-3 text-[#FF8566]" />
          ...
          <div className="flex items-center gap-1">
            <Globe className="w-3 h-3 text-[#FF8566] hidden xs:inline" />
            <CurrencySelector
